  ...
  return (
    ...
    <div onClick={() => router.push('/')} className=' pt-[57px] cursor-pointer flex'>
        ...
        <div className='flex pt-[72px] font-noto text-[16px] text-white'>
            ...
            <div onClick={() => router.push('#')} className='mr-[20px] cursor-pointer leading-[10px] '>NOTIFICATION</div>
            <div onClick={() => router.push('/community')} className='mr-[20px] cursor-pointer leading-[10px] '>COMMUNITY</div>
        </div> 
        <div >
        <div onClick={() => connectWallet()} className='bg-[#A77300] text-[12px] font-noto cursor-pointer font-semibold py-3 mt-[57px] w-[120px] h-[40px] text-center rounded-[10px]'>CONNECT WALLET</div>
    </div>
    </div>
</div>
  )
